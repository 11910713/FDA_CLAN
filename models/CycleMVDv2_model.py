...
class CycleMVDv2Model(BaseModel):
    @staticmethod
    ...
    def __init__(self, opt):
        ...
        # visualization
        self.loss_names = ['Di', 'CE', 'adv_Di', 'con', 'con_target', 'con_source']
    ...
    def optimize_parameters(self):
        ...
        self.set_requires_grad([self.netDi], True)
        self.forward()
        self.foward_D()
        self.backward_D()
        self.optimizer_Di.step()
        self.set_requires_grad([self.netDi], False)
        self.backward_G()
    ...
    def backward_G(self):
        ...
        # image
        # consistency
        self.loss_con_target = self.L1Loss(self.reg_target, self.target_input)
        ...
        self.loss_G = self.loss_CE + self.loss_adv_Di + self.loss_con
